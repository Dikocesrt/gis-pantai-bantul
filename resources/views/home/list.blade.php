                ...
                <div class="grid grid-cols-1 md:grid-cols-7 gap-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="kondisiDropdown"
                            class="hidden absolute z-50 w-80 mt-2 bg-white border border-gray-200 rounded-lg shadow-xl max-h-96 overflow-y-auto">

                            <!-- Tingkat Keamanan -->
                            <div class="border-b border-gray-100">
                                <div class="px-3 py-2 bg-gray-50 sticky top-0">
                                    <p class="text-xs font-bold text-gray-700 uppercase tracking-wide">Tingkat Keamanan</p>
                                </div>
                            ...
                            <div class="border-b border-gray-100">
                                <div class="px-3 py-2 bg-gray-50 sticky top-0">
                                    <p class="text-xs font-bold text-gray-700 uppercase tracking-wide">Tingkat Kebersihan
                                    </p>
                                </div>
                            ...
                            <div class="border-b border-gray-100">
                                <div class="px-3 py-2 bg-gray-50 sticky top-0">
                                    <p class="text-xs font-bold text-gray-700 uppercase tracking-wide">Aksesibilitas Jalan
                                    </p>
                                </div>
                            ...
                            <div class="border-b border-gray-100">
                                <div class="px-3 py-2 bg-gray-50 sticky top-0">
                                    <p class="text-xs font-bold text-gray-700 uppercase tracking-wide">Kondisi Ombak</p>
                                </div>
