            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <div class="relative group">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="relative">
                                                            @if ($tempatWisata->road_accessibility == 'mudah_diakses')
                                                                Semua jenis kendaraan (motor, mobil, bus) dapat dengan mudah
                                                                mencapai lokasi. Jalan beraspal dan kondisi baik.
                                                            @elseif($tempatWisata->road_accessibility == 'cukup_mudah')
                                                                Kendaraan kecil (motor, mobil) mudah akses. Kendaraan besar
                                                                (bus, truk) perlu kehati-hatian ekstra karena jalan yang
                                                                agak sempit atau berkelok.
                                                            @elseif($tempatWisata->road_accessibility == 'sulit_diakses')
                                                                Akses terbatas, lebih cocok untuk motor atau kendaraan
                                                                kecil. Jalan mungkin sempit, berbatu, atau belum beraspal
                                                                sempurna.
                                                            @endif
                                                            <div
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-24">
                        ...
                        @if ($tempatWisata->website || $tempatWisata->facebook || $tempatWisata->instagram || $tempatWisata->tiktok)
                            <div class="mt-6 pt-6 border-t border-gray-200">
                                <h4 class="text-sm font-bold text-gray-900 mb-3">Sosial Media</h4>
                                <div class="flex flex-wrap gap-3">
                                    @if ($tempatWisata->website)
                                        <a href="{{ $tempatWisata->website }}" target="_blank" rel="noopener noreferrer"
                                            class="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-all duration-200 group">
                                    ...
                                    @if ($tempatWisata->facebook)
                                        <a href="{{ str_starts_with($tempatWisata->facebook, 'http') ? $tempatWisata->facebook : 'https://facebook.com/' . ltrim($tempatWisata->facebook, '@') }}"
                                            target="_blank" rel="noopener noreferrer"
                                            class="flex items-center gap-2 px-4 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg transition-all duration-200 group">
                                    ...
                                    @if ($tempatWisata->instagram)
                                        <a href="{{ str_starts_with($tempatWisata->instagram, 'http') ? $tempatWisata->instagram : 'https://instagram.com/' . ltrim($tempatWisata->instagram, '@') }}"
                                            target="_blank" rel="noopener noreferrer"
                                            class="flex items-center gap-2 px-4 py-2 bg-pink-100 hover:bg-pink-200 text-pink-700 rounded-lg transition-all duration-200 group">
                                            <svg class="w-5 h-5 group-hover:scale-110 transition-transform"
                                                fill="currentColor" viewBox="0 0 24 24">
                                                <path
                                    ...
                                    @if ($tempatWisata->tiktok)
                                        <a href="{{ str_starts_with($tempatWisata->tiktok, 'http') ? $tempatWisata->tiktok : 'https://tiktok.com/@' . ltrim($tempatWisata->tiktok, '@') }}"
                                            target="_blank" rel="noopener noreferrer"
                                            class="flex items-center gap-2 px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-all duration-200 group">
                                            <svg class="w-5 h-5 group-hover:scale-110 transition-transform"
                                                fill="currentColor" viewBox="0 0 24 24">
                                                <path
