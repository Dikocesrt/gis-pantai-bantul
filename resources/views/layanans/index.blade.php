...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-gray-600 text-sm font-medium mb-2">Total Layanan</p>
                    <h3 class="text-4xl font-bold text-gray-900">{{ $layanans->count() }}</h3>
                </div>
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="text-4xl font-bold text-gray-900">
                        {{ $layanans->where('created_at', '>=', now()->startOfDay())->count() }}</h3>
                </div>
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="text-lg font-bold text-gray-900">
                        {{ $layanans->first()?->updated_at?->diffForHumans() ?? 'Belum ada data' }}</h3>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="p-6 border-b border-gray-200 flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 text-sm mt-1">Kelola semua data layanan</p>
            </div>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-600 font-medium">Belum ada data layanan</p>
                                    <p class="text-gray-500 text-sm mt-1">Klik tombol "Tambah Layanan" untuk menambahkan
                                        data</p>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all relative z-[101]">
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-2xl font-bold text-gray-900">Tambah Layanan</h3>
            ...
            <form action="{{ route('layanans.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                <div class="mb-4">
    ...
    <div id="editModal" class="hidden fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all relative z-[101]">
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-2xl font-bold text-gray-900">Edit Layanan</h3>
    ...
    <div id="deleteModal" class="hidden fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all relative z-[101]">
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-2xl font-bold text-gray-900">Hapus Layanan</h3>
                ...
                <div class="mb-6">
                    <div class="flex items-center gap-4 p-4 bg-red-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Data layanan "<span id="delete_name"
    ...
    <script>
        ...
        function openEditModal(layanan) {
            ...
            document.getElementById('edit_name').value = layanan.name;
            document.getElementById('editForm').action = `/layanans/${layanan.id}`;

            // Show current icon using Cloudinary URL
            document.getElementById('edit_current_icon').src = layanan.icon_url;
        ...
        function openDeleteModal(layanan) {
            document.getElementById('deleteModal').classList.remove('hidden');
            document.getElementById('delete_name').textContent = layanan.name;
            document.getElementById('deleteForm').action = `/layanans/${layanan.id}`;
        }
